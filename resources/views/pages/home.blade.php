    ...
    <nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
            ...
            <div class="container pt-2">
                <div class="row align-items-center mb-5">
                    <div class="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0">
                        <h2 class=" fw-bold mb-3">Elevate Your Sales with  yeahiea's  Powerful POS Application! </h2>
                    ...
                    <div class="col-12 col-lg-6 offset-lg-1">
                        <img class="img-fluid" src="{{asset('/images/hero.avif')}}" alt="">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3 p-3">
                        <div class="card px-0 text-center">
                            <img class=" card-img-top mb-3 w-100" src="{{asset('/images/person.jpg')}}" alt="">
                            <h5>Yeahiea Khan</h5>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-5 mb-5 mb-lg-0">
                        ...
                        <p class="text-muted mb-5">Sirajganj, Dhaka, Bangladesh</p>
                        <h4 class="fw-bold">Contact Us</h4>
                        <p class="text-muted mb-1">yeahiea khan</p>
                        <p class="text-muted mb-0">+880 1719788083</p>
                    </div>
                    <div class="col-12 col-lg-6 offset-lg-1">
                        <form action="#">
        ...
        <footer class="py-5 bg-light">
            <div class="container text-center pb-5 border-bottom">
                ...
                <div>
                    <a class="d-inline-block me-4 target="_blank" href="{{url('https://www.facebook.com/yeahieaKhan83')}}">
