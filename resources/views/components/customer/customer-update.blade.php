...
<script>
    ...
    async function FillUpUpdateForm(id){
        ...
        document.getElementById('customerMobileUpdate').value=res.data['number'];
    }
    ...
    async function Update() {
        ...
        if (customerName.length === 0) {
            ...
            let res = await axios.post("/customer-update",{name:customerName,email:customerEmail,number:customerMobile,id:updateID})
